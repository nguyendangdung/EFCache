...
namespace EFCache
{
    ...
    public class InMemoryCacheTests
    {
        ...
        public void Item_cached()
        {
            ...
            object fromCache;
            Assert.True(cache.GetItem("key", out fromCache, null));
        ...
        public void Item_not_returned_after_absolute_expiration_expired()
        {
            ...
            object fromCache;
            Assert.False(cache.GetItem("key", out fromCache, null));
        ...
        public void InvalidateSets_invalidate_items_with_given_sets()
        {
            ...
            object item;
            Assert.False(cache.GetItem("1", out item, null));
            Assert.False(cache.GetItem("2", out item, null));
            Assert.False(cache.GetItem("3", out item, null));
            Assert.True(cache.GetItem("4", out item, null));
        }
        ...
        public void Purge_removes_stale_items_from_cache()
        {
            ...
            object item;
            Assert.False(cache.GetItem("1", out item, null));
            Assert.True(cache.GetItem("2", out item, null));
        }
        ...
        public void GetItem_validates_parametes()
        {
            ...
            Assert.Equal(
                "key",
                Assert.Throws<ArgumentNullException>(() => new InMemoryCache().GetItem(null, out item, null)).ParamName);
        }
        ...
        public void InvalidateSets_validates_parametes()
        {
            Assert.Equal(
                "entitySets",
                Assert.Throws<ArgumentNullException>(() => new InMemoryCache().InvalidateSets(null, null)).ParamName);
        }
        ...
        public void InvalidateItem_validates_parametes()
        {
            Assert.Equal(
                "key",
                Assert.Throws<ArgumentNullException>(() => new InMemoryCache().InvalidateItem(null, null)).ParamName);
        }
    }
}
